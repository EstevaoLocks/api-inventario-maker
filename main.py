...
class ComponenteSchema(BaseModel): 
    ...
    estado_conservacao: str = Field(..., description="Estado de conservação do item (ex.: novo, seminovo, antigo...)") 
...
estoque_laboratorio = [ 
    ...
    {"id": 3, "nome": "Esteira em Acrílico", "quantidade": 2, "categoria": "Mecânica", "estado_conservacao": "Antigo"} 
] 
